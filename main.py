...
def main():
    ...
    # Replace the simple title with a more engaging title and subheader
    st.markdown("""
    <h1 style="text-align: center; color: #1E88E5; margin-bottom: 0;">✨ Contact Data Enrichment Tool ✨</h1>
    <h3 style="text-align: center; color: #424242; margin-top: 0; font-weight: 300; margin-bottom: 30px;">
        Transform your contact data with AI-powered personality insights and targeting
    </h3>
    """, unsafe_allow_html=True)
